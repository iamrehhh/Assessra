...
const econP4Cards = `
    ...
    <div class="papers-grid">
        <div class="paper-card" onclick="openPaper('econ_2025_mj_41')">
            <span class="paper-tag">9708/41</span>
            <h3>The influence of governments</h3>
            <p style="color:#888; margin-top:5px;">Paper 4 • PDF Available</p>
        </div>
        <div class="paper-card" onclick="openPaper('econ_2025_mj_42')">
            <span class="paper-tag">9708/42</span>
            <h3>Global carbon emissions</h3>
            <p style="color:#888; margin-top:5px;">Paper 4 • PDF Available</p>
        </div>
        <div class="paper-card" onclick="openPaper('econ_2025_mj_43')">
            <span class="paper-tag">9708/43</span>
            <h3>The influence of governments</h3>
            <p style="color:#888; margin-top:5px;">Paper 4 • PDF Available</p>
        </div>
        <div class="paper-card" onclick="openPaper('econ_2025_mj_44')">
            <span class="paper-tag">9708/44</span>
            <h3>Economic development in Bangladesh</h3>
            <p style="color:#888; margin-top:5px;">Paper 4 • PDF Available</p>
        </div>
    </div>
    ...
    <div class="papers-grid">
        <div class="paper-card" onclick="openPaper('econ_2024_mj_41')">
            <span class="paper-tag">9708/41</span>
            <h3>Income inequality</h3>
            <p style="color:#888; margin-top:5px;">Paper 4 • PDF Available</p>
        </div>
        <div class="paper-card" onclick="openPaper('econ_2024_mj_42')">
            <span class="paper-tag">9708/42</span>
            <h3>Developments in the electric vehicle (EV) industry</h3>
            <p style="color:#888; margin-top:5px;">Paper 4 • PDF Available</p>
        </div>
    ...
    <div class="papers-grid">
        <div class="paper-card" onclick="openPaper('econ_2024_fm_42')">
            <span class="paper-tag">9708/42</span>
            <h3>French electricity prices</h3>
            <p style="color:#888; margin-top:5px;">Paper 4 • PDF Available</p>
        </div>
    </div>
`;
