...
CRITICAL: DO NOT copy these instructions into the output. You must strictly output ONLY the newly generated essay text answering the specific question above.>"""
        ...
        model_answer_instruction = (
            ...
            f"- Writing Style (CRITICAL): The tone must NOT sound like an AI. It must sound like a high-level high school student writing a personal, evocative, and observant essay. Use varied sentence lengths, descriptive imagery, relatable and slightly informal but articulate transitions, and personal/observational anecdotes where appropriate to anchor points. Avoid robotic connectors like 'Furthermore', 'Moreover', and 'In conclusion'. Mimic the cadence of a thoughtful student who connects abstract ideas to tangible, lived experiences.\n"
