...
Object.assign(paperData, {
    ...
    'gp_2025_on_21': {
        ...
        questions: [
            { n: '1(a)', m: 2, l: '', t: 'With reference to the Background and the Additional Information only, identify two pieces of evidence showing that Ereeka might not have the necessary experience to organise a \'memorable\' press launch.', i: [], a: 'Credit the following two points.\nEreeka had only started as Director of Publicity three weeks ago. (1)\nOne month ago, Ereeka graduated from university with a degree in archaeology. (1)' },
            { n: '1(b)', m: 1, l: '', t: 'Identify the disadvantage with The Beeches.', i: [], a: 'Credit the following point.\nIt is (only) a two-star hotel. (1)' },
            { n: '1(c)', m: 1, l: '', t: 'Identify the likely date for the press launch.', i: [], a: 'Credit the following point.\n10 March. (1)' },
            { n: '1(d)', m: 3, l: '', t: 'Explain why Ereeka will have to ask Caradoc Schmidt for an increased budget for the press launch.', i: [], a: 'Credit any three of the following points.\nThe current budget of $30 000 will not cover all the costs. (1)\n120 delegates could cost up to $30 000 alone, if they all requested an overnight stay. (1)\nThe gourmet buffet lunch (that Caradoc would probably want) costs $2400. (1)\nOrlando Teeme\'s personal expenses would come to $3500. (1)\nThere is the potential for up to 30 more delegates to indicate that they will attend. (1)\nOvertime may be necessary to speed up production to meet the preferred launch date (increasing costs further). (1)' },
            { n: '1(e)', m: 8, l: '', t: 'Apart from the cost, explain the disadvantages of The Tuila Hotel and Conference Centre as a venue for the press launch. Answer in continuous prose.', i: [], a: 'Caradoc Schmidt specified a venue within 5 km of the office, but The Tuila Hotel and Conference Centre is 8 km away.\nThe Tuila Hotel and Conference Centre\'s head chef has just broken both wrists, so the food might not be up to gourmet standard / and one of CS\' specifications in his email was for a lunch of an excellent standard / so a less qualified chef might have to take over / so the venue might not find a replacement chef in time.\nThe Tuila Hotel and Conference Centre has only been open since 15 January, so Ereeka will not have been able to check many online reviews to ensure that it is of five-star standard / to see how it had coped previously with events as large as their press launch.\nThe engineer hoping to repair The Tuila Hotel and Conference Centre\'s audio-visual equipment cannot come before 9 March / the day before the likely date of the press conference, so it allows no room for manoeuvre if the engineer cannot repair the equipment/ needs to order a part.' },
            { n: '1(f)', m: 3, l: '', t: 'Explain why working with Orlando Teeme has been a particularly stressful time for Klaus, the Director of Manufacturing.', i: [], a: 'Credit three of the following points or any other valid point.\nThere has been an issue at every stage of production, (1) as Orlando Teeme changed his design (from a simple one) to a more complicated one (1) and the gold edging would have increased the level of technicality required. (1) Now they are two months behind schedule. (1)\nOrlando\'s demanding and diva-like character has clearly worn him out. (1)' },
            { n: '1(g)', m: 1, l: '', t: 'With reference to the Additional Information, identify the reason why Caradoc Schmidt might soon regret linking his company\'s reputation with that of Orlando Teeme.', i: [], a: 'Credit the following point.\nOrlando Teeme is going to be accused in a national newspaper of stealing recipe ideas from his junior chefs. (1)' },
            { n: '1(h)', m: 4, l: '', t: 'In your opinion, explain why, as Schmidt + Daughters Tableware has its own design team, Caradoc Schmidt asked Orlando Teeme to design a product range for them.', i: [], a: 'Credit four of the following points or any other valid points.\nOrlando Teeme is a celebrity TV chef, (1) so he is likely to have hundreds of thousands of fans, (1) many of whom would happily buy tableware designed by Orlando, (1) which might help their meals look as good as his culinary creations. (1)\nSchmidt + Daughters Tableware can charge a premium on products endorsed by famous people, (1) whereas in-house tableware design teams are not normally known by anyone outside their industry. (1)' },
            { n: '1(i)', m: 2, l: '', t: 'In your opinion, suggest why celebrities feel the need to be chauffeured in limousines.', i: [], a: 'Credit two of the following points or any other valid point.\nThey might feel vulnerable travelling in public transport, (1) worrying about being bothered by over-zealous fans or people with bad intentions. (1)\nThey might worry about getting lost trying to find the venue. (1)\nThey might think that it underlines their status as a celebrity. (1)\nThey might revel in being regarded as high-wealth individuals. (1)\nThey can post pictures on social media to impress their followers. (1)' },
            { n: '2(a)', m: 1, l: '', t: 'Identify when lulia Bochis started to become interested in illustrations, specifically.', i: [], a: 'Credit the following point. (She started to become interested in them) when she started using social media. (1)' },
            { n: '2(b)(i)', m: 1, l: '', t: 'Using your own words as far as possible, explain the meaning of the following five phrases as used in the material: \'something changed in me\' (lines 9-10)', i: [], a: 'she altered her attitude (1)' },
            { n: '2(b)(ii)', m: 1, l: '', t: 'Using your own words as far as possible, explain the meaning of the following five phrases as used in the material: \'felt a strong desire to travel\' (line 10)', i: [], a: 'experienced a great need to explore (1)' },
            { n: '2(b)(iii)', m: 1, l: '', t: 'Using your own words as far as possible, explain the meaning of the following five phrases as used in the material: \'obstacles that got in the way\' (line 12)', i: [], a: 'barriers that prevented her (1)' },
            { n: '2(b)(iv)', m: 1, l: '', t: 'Using your own words as far as possible, explain the meaning of the following five phrases as used in the material: \'after much deliberation\' (line 12)', i: [], a: 'having thought a great deal (1)' },
            { n: '2(b)(v)', m: 1, l: '', t: 'Using your own words as far as possible, explain the meaning of the following five phrases as used in the material: \'there wasn\\\'t a better moment than "now"\' (lines 12-13).', i: [], a: 'the present was the perfect opportunity (1)' },
            { n: '2(c)(i)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: life-changing (lines 9-18)', i: [], a: 'transformative (1)' },
            { n: '2(c)(ii)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: imagination (lines 20-25)', i: [], a: 'mind\'s eye (1)' },
            { n: '2(c)(iii)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: affect emotionally (lines 20-25)', i: [], a: 'touch (1)' },
            { n: '2(c)(iv)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: remedy (lines 29-34)', i: [], a: 'antidote (1)' },
            { n: '2(c)(v)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: encouraging (lines 44-56).', i: [], a: 'uplifting (1)' },
            { n: '2(d)(i)', m: 1, l: '', t: 'Regarding lulia\'s site: describe what makes her feel humble', i: [], a: '(She feels humble) when she receives messages from around the world/ people let her know that her work brings them a sense of lightness and comfort. (1)' },
            { n: '2(d)(ii)', m: 1, l: '', t: 'Regarding lulia\'s site: identify the comparison she makes to describe her site.', i: [], a: '(She considers it as a corner of the internet that\'s like) a sunny garden for people to sit and relax in (at any time). (1)' },
            { n: '2(e)', m: 2, l: '', t: 'According to lulia, identify one advantage and one disadvantage of an easily accessible virtual world.', i: [], a: 'Advantage: (It allows many) individuals and communities to have a far-reaching voice (for the first time). (1)\nDisadvantage: It has become more difficult to build real and lasting relationships/ Everything changes so quickly. (1)' },
            { n: '2(f)', m: 5, l: '', t: 'Explain the structure of lulia\'s book (lines 44-52). Answer in about 50 words using continuous prose.', i: [], a: 'Credit any three of the following points.\nIt is built around the four seasons. (1)\nIt draws parallels between life stages and the changing seasons. (1)\nAutumn invites us to reflect on the nature of change. (1)\nDark winter days are for self-reflection and focusing on ourselves. (1)\nSpring marks rebirth, allowing us reflection both backwards and forwards. (1)\nSummer liberates, letting us glide along, surrendering to life\'s flow. (1)' },
            { n: '2(g)(i)', m: 1, l: '', t: 'State the exact meaning of the following five words as they are used in the material: thought-provoking (line 7)', i: [], a: 'stimulating, intriguing, riveting, striking, inspirational, absorbing, engaging (1)' },
            { n: '2(g)(ii)', m: 1, l: '', t: 'State the exact meaning of the following five words as they are used in the material: perspective (line 20)', i: [], a: 'angle, viewpoint/ point of view, mindset, standpoint, way of looking, outlook, position, situation, slant (1)' },
            { n: '2(g)(iii)', m: 1, l: '', t: 'State the exact meaning of the following five words as they are used in the material: resilient (line 26)', i: [], a: 'strong, tough, hardy, flexible (1)' },
            { n: '2(g)(iv)', m: 1, l: '', t: 'State the exact meaning of the following five words as they are used in the material: solace (line 31)', i: [], a: 'consolation, comfort, relief, easing (1)' },
            { n: '2(g)(v)', m: 1, l: '', t: 'State the exact meaning of the following five words as they are used in the material: superficial (line 35).', i: [], a: 'shallow, trivial, glib, fatuous, facile, flippant, empty, meaningless (1)' }
        ]
    },
    ...
    'gp_2025_on_22': {
        ...
        questions: [
            { n: '1(a)', m: 2, l: '', t: 'Explain how Sarantown University would be more likely to recover the building costs if they were to choose Sarantown Select\'s proposal.', i: [], a: 'Sarantown Select\'s proposal is within budget (1) and would accommodate 180 students. (1)\n(180 students paying $4000 rent per year) would cover (the $2.1 million) build cost in roughly three years. (1)' },
            { n: '1(b)(i)', m: 1, l: '', t: 'With reference to the Additional Information only: state the one piece of information which suggests that Georg Walters\' claim to offer \'fully costed construction plans\' might be untrue.', i: [], a: 'Point 13./ Barton Build\'s swimming pool project resulted in a large overspend because some of the design features required much more technical expertise and materials than had initially been evident from the plans submitted. (1)' },
            { n: '1(b)(ii)', m: 2, l: '', t: 'With reference to the Additional Information only: state two pieces of information which suggest that tourists may not wish to stay in the new building.', i: [], a: 'Point 6./ The new building will be located some seven kilometres to the east of the city centre. (1)\nPoint 9./The new building will form one part of extensive redevelopment work recently approved by the city planning department. (1)\nPoint 16./(There are good bus routes all over the city, although) buses in the east of the city are infrequent after 20:00. (1)' },
            { n: '1(c)', m: 10, l: '', t: 'Apart from financial reasons, explain why Bilal Mendes-Smith is more likely to choose Sarantown Select to design the new student accommodation block. Do not refer to Barton Build. Answer in continuous prose.', i: [], a: 'Sarantown Select\'s plan can house 180 and the university wishes to accommodate as many students as possible on the site.\nSarantown Select was set up by former university students, so they are likely to be well in touch with the needs of (final-year) students in that particular city.\nThe solar panels will provide energy for all the hot water and lighting required in the building, so the construction is likely to meet the required environmental standards/demands of the energy efficiency certification.\nProvision for bicycle storage links well with the transportation habits of students in the city.\nTheir reputation for modern, functional design/intention to focus less on the exterior might well appeal to the young/student residents.\nThe recent winning of the regional award suggests a high level of competence/flair/a growing reputation.\nThe company has recently worked on both a high school\'s new computer and resource suite and a hotel, both of which would have significant similarities to the current project.\nThe focus on quiet study spaces, including sound-proofing the walls/the lack of potentially noisy common meeting spaces might appeal to university staff as likely to improve results/performance and would likely appeal to final-year students preparing for their final exams.\nThe idea for inwards-facing rooms facing away from the roads, thoughtfully takes into account the location on an ongoing development site.\nWi-Fi connectivity is seen as essential, which is likely to be agreed on by/a priority for students.\nThe state-of-the-art security system (linked to smartphones) addresses the issue of rising crime in Sarantown.\nBilal Mendes-Smith might think his nephew would have a good chance of a work placement/eventual job with the company, as he is about to start the architecture course/the firm offers such a scheme at present.\nKaren Stevens emphasises almost immediately her focus on the student experience and seems to have given a lot of thought to (final-year) students\' priorities/thinks back specifically to her own experiences at that time.' },
            { n: '1(d)', m: 8, l: '', t: 'Apart from any financial considerations, explain four reasons which suggest that Georg Walters has not read the contract brief properly. Do not refer to Sarantown Select.', i: [], a: 'Plans were submitted later than the deadline (1), suggesting a lack of the reliability the university was seeking/lack of enthusiasm. (1)\nThe suggestion of cafés in communal areas (1) goes against the university\'s aims to house as many final-year students as possible. (1)\nThe university has mentioned necessary shared facilities in the brief (1) however Georg discusses en-suite bathrooms/(luxurious) communal facilities. (1)\nThe plan to \'go upwards\'/construct a six-storey building (1) shows a lack of knowledge of the latest local planning restrictions in that development area/the permitted maximum being three. (1)\nAir conditioning and high-specification entertainment features demand a lot of energy (1), so the building risks failing the energy efficiency certification. (1)\nHe seems more focused on the tourists and conference attendees than students (1), but they would occupy the rooms for a maximum of 12 weeks per year/the students will be there 40 weeks per year. (1)\nGeorg Walters\' initial emphasis seems to be more on what the company likes to achieve/style/beautiful buildings (1) rather than focusing on the students\' or client\'s needs. (1)\nHe believes most university buildings to be unattractive boxes (1), suggesting he has not even visited Sarantown University\'s campus and its historic buildings. (1)\nGeorg Walters claims he knows what students want (1), but recognises that times have changed/seems distant from young people. (1)' },
            { n: '1(e)', m: 2, l: '', t: 'Explain how Bilal Mendes-Smith could have made the contract brief more specific.', i: [], a: 'Credit any two of the following points or any other valid point:\nThe brief does not specify a target number of rooms (1) or which shared facilities should be included. (1) Consequently, it is not clear what the priorities are for Sarantown University/what the companies need to achieve in their plans. (1)\nThere is no mention of what the budgetary constraints or \'other considerations\' might involve. (1)\nIt is unlikely that any company will consider itself as not \'reliable\'. (1)\nThe brief uses terms such as \'ideally\' and \'maybe\', suggesting the intended outcomes are not even known/fully clear to those commissioning the work. (1)\nThe word \'appropriate\' could be clearer. (1)\nIt might well be difficult to envisage facilities which will appeal to both students and to conference guests/tourists. (1)' },
            { n: '2(a)', m: 3, l: '', t: 'Identify three different informal language features in lines 1-3.', i: [], a: 'Credit any three of the following: Use of colloquial/slang terms (1), Use of (two) rhetorical questions (1), Direct address/use of the second person (1), Contraction of \'you are\' to \'you\'re\' (1), Incomplete sentences/missed auxiliary verbs (in the first two questions) (1)' },
            { n: '2(b)', m: 3, l: '', t: 'Identify three reasons why an individual might consider quiet quitting (lines 9-16). Answer in about 30 words using continuous prose.', i: [], a: 'Workers are unwilling to do anything not clearly demanded in contracts / reflected in salaries. (1)\nThere is pressure to arrive early and work late (1) and read documents / complete other work-related activities after hours. (1)\nIndividuals can begin to have negative feelings regarding the workplace / their boss. (1)\nPeople prefer to have a work-life balance. (1)' },
            { n: '2(c)', m: 4, l: '', t: 'Identify four of the ways in which the working from home (WFH) phenomenon has changed people\'s attitudes to work and leisure time.', i: [], a: 'The Covid19-enforced lockdowns made working from home commonplace (1), which blurred the lines between work time and leisure time. (1)\n(As a result,) people questioned their values and priorities. (1)\nTechnology enables communication to be constant (1), including emails arriving over the weekend which are a distraction / hard to ignore (1), and even well-intentioned messages received during travel/holiday time intrude/pressurise. (1)' },
            { n: '2(d)(i)', m: 1, l: '', t: 'Using your own words as far as possible, state the meaning of the following five phrases, as they are used in the material: most of us are eager to please (line 31)', i: [], a: 'the majority are keen to make others happy (1)' },
            { n: '2(d)(ii)', m: 1, l: '', t: 'Using your own words as far as possible, state the meaning of the following five phrases, as they are used in the material: even more so if we like our boss (line 32)', i: [], a: 'in particular when the employee has respect for the manager (1)' },
            { n: '2(d)(iii)', m: 1, l: '', t: 'Using your own words as far as possible, state the meaning of the following five phrases, as they are used in the material: those who choose not to join in may be criticised (line 33)', i: [], a: 'anyone not complying is likely to face censure (1)' },
            { n: '2(d)(iv)', m: 1, l: '', t: 'Using your own words as far as possible, state the meaning of the following five phrases, as they are used in the material: existing issues are never addressed (line 40)', i: [], a: 'the (current) problems are not dealt with (1)' },
            { n: '2(d)(v)', m: 1, l: '', t: 'Using your own words as far as possible, state the meaning of the following five phrases, as they are used in the material: further burdens your colleagues (lines 41-42).', i: [], a: 'causes their co-workers extra work/pressure (1)' },
            { n: '2(e)(i)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: withdrawing (from) (lines 1-13)', i: [], a: 'disengaging (from) (1)' },
            { n: '2(e)(ii)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: sidelined (lines 30-43)', i: [], a: 'marginalised (1)' },
            { n: '2(e)(iii)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: (to) stop working (lines 39-57)', i: [], a: '(to) down tools (1)' },
            { n: '2(e)(iv)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: mutinous (lines 50-60)', i: [], a: 'disaffected (1)' },
            { n: '2(e)(v)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: harmful (lines 50-60)', i: [], a: 'toxic (1)' },
            { n: '2(e)(vi)', m: 1, l: '', t: 'Identify the exact word or phrase in the material which means the following: (to) work beyond expectations (lines 61-71).', i: [], a: '(to) go the extra mile (1)' },
            { n: '2(f)', m: 2, l: '', t: 'In your opinion, suggest one example of a reward an employee might be able to negotiate with their supervisor. Justify your response.', i: [], a: 'A pay rise/promotion (1) may show that their hard work and dedication has been noted/recognised. (1)\nExtra pay/overtime pay (1) is likely to recognise the extra hours of work outside of the contracted work hours. (1)\nAdditional holiday time (1) might allow an employee to spend quality time with the family. (1)\nAppreciation (1) is likely to further motivate the employee. (1)\nTraining paid for by the company (1) increases their employability and expands their skillset. (1)' },
            { n: '2(g)', m: 2, l: '', t: 'In your opinion, explain what is meant by the following quotation: \'You can\'t change someone who doesn\'t see an issue in their actions\' (Unknown). Do not repeat any material from Section B.', i: [], a: 'When others believe that their behaviour is without fault, they will be unwilling to make changes. (1) People need to understand that they can be wrong and there is room for improvement. (1)\nUntil a person takes responsibility for their actions, they, or those around them, are unable to address it. (1) For example, someone unable to limit their budget in line with their spending despite constant advice. (1)' }
        ]
    },
